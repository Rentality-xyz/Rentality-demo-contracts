...
const zeroHash = ethers.zeroPadBytes(ethToken, 32)
...
async function deployDefaultFixture() {
    ...
    await rentalityGateway.connect(host).setKYCInfo(' ', ' ', ' ', ' ', ' ', 1, hostSignature, zeroHash)
    await rentalityGateway.connect(guest).setKYCInfo(' ', ' ', ' ', ' ', ' ', 1, guestSignature, zeroHash)

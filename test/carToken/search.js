...
describe.only('RentalityCarToken: search functions', function () {
    ...
    it('Search with model should work', async function () {
        const {rentalityCarToken, rentalityTripService, guest,rentalityGateway} = await loadFixture(deployFixtureWith1Car)
    ...
    it('Search with state should work', async function () {
        const {rentalityCarToken, rentalityTripService, guest, geoParserMock,rentalityGateway} = await loadFixture(deployFixtureWith1Car)

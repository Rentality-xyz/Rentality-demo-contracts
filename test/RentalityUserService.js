...
describe("RentalityUserService", function () {
  ...
  async function deployDefaultFixture() {
    ...
    const [owner, anonymous] = await ethers.getSigners();
    ...
    return { rentalityUserService, owner, anonymous };
  }
  ...
  async function deployFixtureWithUsers() {
    ...
    return { rentalityUserService, owner, admin, manager, host, guest, anonymous };
  }

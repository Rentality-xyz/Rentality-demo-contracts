...
const commands = [
  ...
  { message: 'Deploying car gateway facet 1..', command: command + 'deploy_4m_CarGatewayFacet1.js' },
  { message: 'Deploying car gateway facet 2..', command: command + 'deploy_4m1_CarGatewayFacet2.js' },
  { message: 'Deploying payment gateway facet..', command: command + 'deploy_4n_PaymentGatewayFacet.js' },
  { message: 'Deploying pricing gateway facet..', command: command + 'deploy_4o_PricingGatewayFacet.js' },

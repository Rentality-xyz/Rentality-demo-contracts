...
async function main() {
  ...
  const rentalityHistoryService = getContractAddress(
    "RentalityHistoryService",
    "scripts/deploy_2e_RentalityHistoryService.js"
  )
  ...
  console.log('rentalityHistoryServiceAddress is:', rentalityHistoryService)

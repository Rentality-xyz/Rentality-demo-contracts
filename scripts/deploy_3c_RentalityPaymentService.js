...
async function main() {
  ...
  const taxes = checkNotNull(
    getContractAddress('Taxes', 'scripts/deploy_2e_Taxes.js', chainId),
    'Taxes'
  )
  const baseDiscount = checkNotNull(
    getContractAddress('BaseDiscount', 'scripts/deploy_2g_BaseDiscount.js', chainId),
    'BaseDiscount'
  )

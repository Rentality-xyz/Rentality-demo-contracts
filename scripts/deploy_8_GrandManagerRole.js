...
async function main() {
  ...
  const platformCallers = [
    ...
    ['TripMainFacet1', getOptionalAddress(addresses, 'TripMainFacet1')],
    ['CarGatewayFacet', getOptionalAddress(addresses, 'CarGatewayFacet')],
    ['CarGatewayFacet1', getOptionalAddress(addresses, 'CarGatewayFacet1')],
    ['CarGatewayFacet2', getOptionalAddress(addresses, 'CarGatewayFacet2')],
    ['PaymentGatewayFacet', getOptionalAddress(addresses, 'PaymentGatewayFacet')],
    ['PricingGatewayFacet', getOptionalAddress(addresses, 'PricingGatewayFacet')],

...
async function main() {
  ...
  const platformCallers = [
    ...
    ['RentalPricingMain', getOptionalAddress(addresses, 'RentalPricingMain')],
    ['RentalClaimStore', getOptionalAddress(addresses, 'RentalClaimStore')],
    ...
    ['RentalityTaxes', getOptionalAddress(addresses, 'RentalityTaxes')],
    ['RentalityBaseDiscount', getOptionalAddress(addresses, 'RentalityBaseDiscount')],

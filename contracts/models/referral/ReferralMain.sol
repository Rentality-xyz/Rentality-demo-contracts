...
interface IReferralAccess { function isRentalityPlatform(address user) external view returns (bool); }

interface IReferralCarQuery {
...
contract ReferralMain is ReferralBase, UUPSOwnable {
  IReferralAccess public userAccess;
  IReferralCarQuery public carQuery;
  ...
  function initialize(
    ...
    __Ownable_init();
    userAccess = IReferralAccess(userAccessAddress);
    carQuery = IReferralCarQuery(carQueryAddress);
